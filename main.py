...
graph_gt = map1
graph_prop = map2
for node in graph_gt.nodes.keys():
    graph_gt.nodeScore[node] = 100

for edge in graph_gt.edges.keys():
    graph_gt.edgeScore[edge] = 100

for node in graph_prop.nodes.keys():
    graph_prop.nodeScore[node] = 100

for edge in graph_prop.edges.keys():
    graph_prop.edgeScore[edge] = 100
